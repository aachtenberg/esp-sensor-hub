...
// Camera model selection - uncomment the one matching your hardware
// #define CAMERA_MODEL_ESP32S3_EYE    // For ESP32-S3 modules
#define CAMERA_MODEL_AI_THINKER        // For ESP32-CAM (AI-Thinker)

#ifdef CAMERA_MODEL_AI_THINKER
// ESP32-CAM (AI-Thinker) pin definitions with OV2640
